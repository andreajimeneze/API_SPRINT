...
export const getNumDoc = async (req, res) => {
    try {
...
export const setNumDoc = async (req, res) => {
    try {
...
// ELIMINAR NÚMERO DE DOCUMENTO
export const deleteNumDoc = async (req, res) => {
    try {
        const { id } = req.params
...
export const updateNumDoc = async (req, res) => {
    try {
        const { id } = req.params;
